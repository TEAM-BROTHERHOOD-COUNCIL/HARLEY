...
IMAGE_THUMBNAIL = "https://telegra.ph/file/4e080b3c7a3f8f3041ad1.jpg"
        ...
        if replied.video or replied.document:
            ...
            if len(m.command) < 2:
                await m.reply_photo(
                    ...
                    [
                        [
                            InlineKeyboardButton("📣 Channel", url=f"https://t.me/INDIA_UNITED"),
                            InlineKeyboardButton("💭 Support", url=f"https://t.me/INDIA_UNITED_SUPPORT")
                        ],
                        [
